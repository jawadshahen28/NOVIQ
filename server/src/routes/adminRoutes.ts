...
import { updateStoreSettingsBodySchema } from '../validators/settingsValidators.js';
...
adminRouter.get('/settings', getAdminStoreSettings);
adminRouter.patch('/settings', validateRequest({ body: updateStoreSettingsBodySchema }), updateAdminStoreSettings);
